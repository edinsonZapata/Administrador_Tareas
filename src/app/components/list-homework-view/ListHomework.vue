    ...
    <div class="w-100 h-100 m-0 p-0 container-view-home">
        <div class="h-100">
            <nav class="d-flex navbar navbar-expand-lg container-view-nav">
                <div class="dropdown">
                    <a href="#" class="d-flex aling-items-center link-white dropdown-toggle text-white">
                ...
                <div action="" class="d-flex p-3">
                    <a class="navbar-brand text-white">Cerrar sesion</a>
            ...
            <div v-if="openModalDeleteHomework" class="modal fade show " style="padding-right: 17px; display:block" data-bs-backdrop="static"
                ...
                <!--Modal crear tarea-->
            <div v-if="openModalCreateHomework" class="modal fade show " style="padding-right: 17px; display:block" data-bs-backdrop="static"
                data-bs-keyboard="false" arial-modal="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content d-flex justify-content-center aling-items-center">
                        <div class="modal-header bg-dark">
                            <div class="container-fluid my-4">
                                <h3 class="text-white">Crear una nueva tarea</h3>
                            </div>
                        </div>
                        <div class="modal-body m-2 ">
                            <div class="container-fluid ">
                                <form class="">
                                    <div class="mb-3 col-sm-12">
                                        <div class="d-flex  flex-md-row aling-items-end">
                                            <div class="form group p-3 col-sm-6 row">
                                                <label class="form-label">Tema:</label>
                                                <input type="text" class="form-control " id="tema" />

                                            </div>
                                            <div class="form group p-3 col-sm-6 modal-lg">
                                                <label class="form-label">Estado:</label>
                                                <!--OPCION TAREA RESUELTA-->
                                        ...
                                        <div class="d-flex flex-column flex-md-row aling-items-end">
                                            ...
                                            <div class=" ">
                                                <div class="form group p-3 .col-xl-12" style="width:360px ;">
                                                    <label class="form-label">Valoración</label>
                                                    <textarea class="form-control" id="valoracion" rows="2"></textarea>
                                                </div>

                                                <div class="form group p-3 .col-xl-12" style="width:360px ;">
                                                    <label class="form-label">Tiempo Estimado</label>
                                                    <input type="date" class="form-control" id="tiempo" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <div class="d-flex flex-column flex-md-row aling-items-end">
                                                ...
                                                <div class="form group p-3 col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" id="encargados" />
                                                </div>
                        ...
                        <div class="modal-footer justify-content-center aling-items-center m-2">
                            <div class="col-2">
                                <a href="../listhomework" type="submit" class="btn btn-primary col-lg-6 mr-4">
                                    Crear
                                </a>
                            </div>
                            <div class="col-5">
                                <a @click="showModalWindowCreateHomework" type="reset" class="btn btn-secondary col-lg-6 mr-2">
                                    Cancelar
                                </a>
                            </div>
                        </div>
            ...
            <!--Modal editar tarea-->
             <div v-if="openModalEditHomework" class="modal fade show " style="padding-right: 17px; display:block" data-bs-backdrop="static"
                data-bs-keyboard="false" arial-modal="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content d-flex justify-content-center aling-items-center">
                        <div class="modal-header bg-dark">
                            <div class="container-fluid my-4">
                                <h3 class="text-white">Editar Tarea</h3>
                            </div>
                        </div>
                        <div class="modal-body m-2 ">
                            <div class="container-fluid ">
                        ...
                        <div class="modal-footer justify-content-center aling-items-center m-2">
                            <div class="col-5">
                                <a href="../listhomework" type="submit" class="btn btn-success col-12 mr-4">
                                    Editar
                                </a>
                            </div>
                            <div class="col-5">
                                <a @click="showModalWindowEditHomework" type="reset" class="btn btn-secondary col-12 mr-2">
                                    Cancelar
                                </a>
                            </div>
                        </div>
                        ...
                        <table class="table text-center">
                            <thead class="col-md-9">
                                <tr class="table-active">
                                    ...
                                    <th scope="col">Tiempo estimado (días)</th>
                            ...
                            <tbody>
                                ...
                                <tr class="table-light">
                                    ...
                                    <td>Realizar la investigación de las funciones que puede realizar el aplicativo</td>
                                    <td>1</td>
                                    ...
                                    <td>Especificar como se comunican las tareas entre ellas, definir las necesidades
                                        para cumplir cada funcionalidad y definir el usuario al que le estamos apuntando
                                    </td>
                                    <td>1</td>
                                ...
                                <tr class="table-light">
                                    <th scope="row">Especificación</th>
                                    <td>Definir como se estructuran dichas funcionalidades</td>
                                    <td>1</td>
                                    <td><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                            fill="currentColor" class="bi bi-check2-circle text-center"
                                            viewBox="0 0 16 16">
                                ...
                                <tr class="table-light">
                                    <th scope="row">Especificación</th>
                                    <td>Definir objetivos que se deben cumplir para el facil uso del aplicativo</td>
                                    <td>2</td>
                                    <td><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                            fill="currentColor" class="bi bi-check2-circle text-center"
                                            viewBox="0 0 16 16">
                                    ...
                                    <td><button  type="button" class="btn btn-outline-secondary"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                <path
                                                    d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                ...
                                <tr class="table-light">
                                    ...
                                    <td>Definir los componentes y como se comunican entre ellos</td>
                                    <td>3</td>
                                    <td><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                            fill="currentColor" class="bi bi-check2-circle text-center"
                                            viewBox="0 0 16 16">
                                ...
                                <tr class="table-light">
                                    <th scope="row">Diseño</th>
                                    <td>Realizar un prototipo del aplicativo</td>
                                    <td>4</td>
                                    <td><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                            fill="currentColor" class="bi bi-check2-circle text-center"
                                            viewBox="0 0 16 16">
                                ...
                                <tr class="table-light">
                                    <th scope="row">Diseño</th>
                                    <td>Realizar el mockup con la herramienta figma, este sera el diseño final del
                                        aplicativo por lo que debe incluir el diseño de cada uno de los componentes</td>
                                    <td>5</td>
                                    <td> <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                            fill="currentColor" class="bi bi-check2-circle text-center"
                                            viewBox="0 0 16 16">
